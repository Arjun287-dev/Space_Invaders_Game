...
icon = pygame.image.load('C:\\SPACE INVADERS\\properties\\icon.png')
pygame.display.set_icon(icon)

# BACKGROUND
background_8x6 = pygame.image.load('C:\\SPACE INVADERS\\properties\\background 8x6.png')
background_13x7 = pygame.image.load('C:\\SPACE INVADERS\\properties\\background 13x7.png')
background_photo = background_8x6
BLACK=(0,0,0)
GREY=(192,192,192)
login_signup_bg_8x6=pygame.image.load('C:\\SPACE INVADERS\\properties\\INTRO_BG_8x6.png')
login_signup_bg_17x7=pygame.image.load('C:\\SPACE INVADERS\\properties\\INTRO_BG_13x7.png')
...
# Define file paths
game_over_path = 'C:\\SPACE INVADERS\\properties\\game-over.mp3'
start_music_path = 'C:\\SPACE INVADERS\\properties\\game-start.mp3'
BG_music_path = 'C:\\SPACE INVADERS\\properties\\background.wav'
bullet_sound_path = 'C:\\SPACE INVADERS\\properties\\laser.wav'
explosion_sound_path = 'C:\\SPACE INVADERS\\properties\\explosion.wav'
select_sound_path = 'C:\\SPACE INVADERS\\properties\\select_sound.mp3'
boss_music_path='C:\\SPACE INVADERS\\properties\\boss_spawn.mp3'
...
def play_ideal_music():
    mixer.music.load('C:\\SPACE INVADERS\\properties\\space_music.mp3')  # Load the music file
...
#Player sprite sheet 
sprite_sheet=pygame.image.load('C:\\SPACE INVADERS\\properties\\starship_sprite_sheet.png').convert_alpha()
...
# Load enemy images
enemy_images = [
    pygame.transform.scale(pygame.image.load(f'C:\\SPACE INVADERS\\properties\\ES-{i}.png'), (140, 145)) 
    for i in range(1, 13)
]
# Load enemy images
boss_images = [
...
bullet_sprite_sheet=pygame.image.load('C:\\SPACE INVADERS\\properties\\P-bullet.png')
pygame.transform.scale((bullet_sprite_sheet),(10,20))

boss_bullet_img=pygame.image.load('C:\\SPACE INVADERS\\properties\\Boss_bullet.png')
...
class Player:
    def __init__(self, x, y, animation_steps):
        try:
            ...
            self.sprite_sheet = pygame.image.load('C:\\SPACE INVADERS\\properties\\starship_sprite_sheet.png').convert_alpha()
    ...
    def draw(self, window, invincible):
        if self.image is None:
            print("Error: Player image not initialized.")
        ...
        for y, animation in enumerate(animation_steps):
            ...
            for x in range(animation):
                try:
                    ...
                    print(f"Failed to load image at ({x}, {y}): {e}")
...
class Enemy:
    ...
    def draw(self, window):
        if self.ship_img is None:
            print("Error: Enemy image not initialized.")
            return  # Skip drawing if the image is not initialized
...
class Bullet:
    def __init__(self, x, y, sprite_sheet, animation_steps):
        ...
        if self.animation_list:
            ...
            print("No images loaded for the bullet.")
    ...
    def draw(self, window):
        if self.image:
            ...
            print("Bullet image not available.")
...
def check_logged_in_user():
    ...
    try:
        ...
        print(f"Error while checking logged-in user: {err}")
        return None
...
# Modified fetch_highest_score function to get the highest score from the database
def fetch_highest_score(username):
    ...
    try:
        ...
        print(f"Error fetching highest score: {err}")
        return 0
...
def get_font(size):
    return pygame.font.Font('C:\\SPACE INVADERS\\properties\\ethnocentric rg.otf', size)

def login_font(size):
    return pygame.font.Font('C:\\SPACE INVADERS\\properties\\Oregon.ttf', size)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN:  # Direct comparison instead of 'in'
                    ...
                    try:
                        if logged_in_user:
                            print(f"Welcome back, {logged_in_user}! Proceeding to the main game.")
                            main(logged_in_user)  # Pass the logged-in user to the main game function
                        else:
                            print("No user is logged in. Please log in or sign up to continue.")
...
def game_over(score_value, level, username):
    ...
    if score_value > highest_score:
        print(f"New high score! Previous: {highest_score}, New: {score_value}")
        update_highest_score(username, score_value)  # Update the database with the new highest score
    else:
        print(f"Current Score: {score_value}, Highest Score: {highest_score}")
...
def gameplay(username, highest_score):
    ...
    while run:
        ...
        if score_value > highest_score:
            ...
            print(f"New highest score for {username}: {highest_score}")
...
def main(username):
    ...
    while True:
        ...
        print(f"Welcome {username}, entering main game.")
